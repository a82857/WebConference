...
btnRegister.addEventListener("click", function(){
    ...
    ( async () => {
        const renderSponsors = document.getElementById("renderSponsot")
        let txtSponsors = ""
        ...
        for (const sponsor of sponsors) {
            ...
            <div class="col-md-3 col-sm-6">
              <a href="${sponsor.link}" target="_blanl">
                <img class="img-fluid d-block mx-auto" src="${sponsor.logo}" alt="${sponsor.nome}"></a>
            </div>`
        }
